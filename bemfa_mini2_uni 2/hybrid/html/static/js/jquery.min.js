/*! jQuery v1.12.0 | (c) jQuery Foundation | jquery.org/license */ ! function(a, b) {
	...
	a.getComputedStyle ? (Ra = function(b) {
		...
		return c = c || Ra(a), g = c ? c.getPropertyValue(b) || c[b] : void 0, c && ("" !== g || n.contains(
					a.ownerDocument, a) || (g = n.style(a, b)), !l.pixelMarginRight() && Oa.test(g) && Na
	...
	n.offset = {
		...
		position: function() {
			if (this[0]) {
				...
				.offset()), c.top += n.css(a[0], "borderTopWidth", !0) - a.scrollTop(), c.left += n
					.css(a[0], "borderLeftWidth", !0) - a.scrollLeft()), {
